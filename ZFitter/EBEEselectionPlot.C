 ...
 */
	...
	TH2F *EEdeltaR9vsR9 = new TH2F("EEdR9vsR9","endcap delta R9 vs R9",1000,-0.5,0.5,1000,0,1);
	TH2F *EBdeltaR9vsR9 = new TH2F("EBdR9vsR9","barrel delta R9 vs R9",1000,-0.5,0.5,1000,0,1);
	TH2F *EEdeltaEvsR9 = new TH2F("EEdEvsR9","endcap delta Esc vs R9",1000,-50,50,1000,0,1);
	TH2F *EBdeltaEvsR9 = new TH2F("EBdEvsR9","barrel delta Esc vs R9",1000,-50,50,1000,0,1);
	TH2F *EEdeltaE5x5vsR9 = new TH2F("EEdE5x5vsR9","endcap delta E5x5 vs R9",1000,-50,50,1000,0,1);
	TH2F *EBdeltaE5x5vsR9 = new TH2F("EBdE5x5vsR9","barrel delta E5x5 vs R9",1000,-50,50,1000,0,1);

	EEdeltaR9vsR9->Sumw2();
	EBdeltaR9vsR9->Sumw2();
	EEdeltaEvsR9->Sumw2();
	EBdeltaEvsR9->Sumw2();
	EEdeltaE5x5vsR9->Sumw2();
	EBdeltaE5x5vsR9->Sumw2();
	gStyle->SetOptStat(0);
	...
	/*	if (entryNumber%10000==0){
			...
			if (eleIndex[0]==1)
			{
				...
				if(fabs(etaSCEle5[0])>1.566)
				{
					EEdeltaR9vsR9->Fill(R9Ele7[0]-R9Ele5[0],R9Ele5[0],selection5);
					EEdeltaEvsR9 ->Fill(energySCEle7[0]-energySCEle5[0],R9Ele5[0],selection5);
					EEdeltaE5x5vsR9 ->Fill(energy5x5Ele7[0]-energy5x5Ele5[0],R9Ele5[0],selection5);
				}
				if(fabs(etaSCEle5[0])<1.4442)
				{
					EBdeltaR9vsR9->Fill(R9Ele7[0]-R9Ele5[0],R9Ele5[0],selection5);
					EBdeltaEvsR9 	->Fill(energySCEle7[0]-energySCEle5[0],R9Ele5[0],selection5); 	
					EBdeltaE5x5vsR9 ->Fill(energy5x5Ele7[0]-energy5x5Ele5[0],R9Ele5[0],selection5);
				}

				if(fabs(etaSCEle5[1])>1.566)
				{
					EEdeltaR9vsR9->Fill(R9Ele7[1]-R9Ele5[1],R9Ele5[1],selection5);
					EEdeltaEvsR9 ->Fill(energySCEle7[1]-energySCEle5[1],R9Ele5[1],selection5);
					EEdeltaE5x5vsR9 ->Fill(energy5x5Ele7[1]-energy5x5Ele5[1],R9Ele5[1],selection5);
				}
				if(fabs(etaSCEle5[1])<1.4442)
				{
					EBdeltaR9vsR9->Fill(R9Ele7[1]-R9Ele5[1],R9Ele5[1],selection5);
					EBdeltaEvsR9 	->Fill(energySCEle7[1]-energySCEle5[1],R9Ele5[1],selection5); 	
					EBdeltaE5x5vsR9 ->Fill(energy5x5Ele7[1]-energy5x5Ele5[1],R9Ele5[1],selection5);
				}
			}
			...
			if (eleIndex[0]==2)
			{
				if(fabs(etaSCEle5[0])>1.566)
				{
					EEdeltaR9vsR9->Fill(R9Ele7[1]-R9Ele5[0],R9Ele5[0],selection5);
					EEdeltaEvsR9 ->Fill(energySCEle7[1]-energySCEle5[0],R9Ele5[0],selection5);
					EEdeltaE5x5vsR9 ->Fill(energy5x5Ele7[1]-energy5x5Ele5[0],R9Ele5[0],selection5);
				}
				if(fabs(etaSCEle5[0])<1.4442)
				{
					EBdeltaR9vsR9->Fill(R9Ele7[1]-R9Ele5[0],R9Ele5[0],selection5);
					EBdeltaEvsR9 	->Fill(energySCEle7[1]-energySCEle5[0],R9Ele5[0],selection5); 	
					EBdeltaE5x5vsR9 ->Fill(energy5x5Ele7[1]-energy5x5Ele5[0],R9Ele5[0],selection5);
				}

				if(fabs(etaSCEle5[1])>1.566)
				{
					EEdeltaR9vsR9->Fill(R9Ele7[0]-R9Ele5[1],R9Ele5[1],selection5);
					EEdeltaEvsR9 ->Fill(energySCEle7[0]-energySCEle5[1],R9Ele5[1],selection5);
					EEdeltaE5x5vsR9 ->Fill(energy5x5Ele7[0]-energy5x5Ele5[1],R9Ele5[1],selection5);
				}
				if(fabs(etaSCEle5[1])<1.4442)
				{
					EBdeltaR9vsR9->Fill(R9Ele7[0]-R9Ele5[1],R9Ele5[1],selection5);
					EBdeltaEvsR9 	->Fill(energySCEle7[0]-energySCEle5[1],R9Ele5[1],selection5); 	
					EBdeltaE5x5vsR9 ->Fill(energy5x5Ele7[0]-energy5x5Ele5[1],R9Ele5[1],selection5);
				}
			}
	}

	TCanvas *t = new TCanvas("t","t",600,600);
	EEdeltaR9vsR9->Draw("COLZ");
	t->SaveAs("selectionPlots/EEdeltaR9vsR9.pdf");
	EEdeltaEvsR9->Draw("COLZ");
	t->SaveAs("selectionPlots/EEdeltaEvsR9.pdf");
	EBdeltaR9vsR9->Draw("COLZ");
	t->SaveAs("selectionPlots/EBdeltaR9vsR9.pdf");
	EBdeltaEvsR9->Draw("COLZ");
	t->SaveAs("selectionPlots/EBdeltaEvsR9.pdf");
	EEdeltaE5x5vsR9->Draw("COLZ");
	t->SaveAs("selectionPlots/EEdeltaE5x5vsR9.pdf");
	EBdeltaE5x5vsR9->Draw("COLZ");
	t->SaveAs("selectionPlots/EBdeltaE5x5vsR9.pdf");
	return 0;
	}
