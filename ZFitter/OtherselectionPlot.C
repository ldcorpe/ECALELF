...
int selectionPlot() 
{
	...
	chain5->SetBranchAddress("energySCEle_corr",energySCEle_corr5,&b_energySCEle_corr5);
	...
	TH1F *E_hist_EE = new TH1F("energySCEle","energySCEle (_7-_5)/_5",10000,-0.4,0.4);
	TH1F *rawE_hist = new TH1F("energySCEle_raw","energySCEle_raw (_7-_5)/_5",10000,-0.4,0.4);
	TH1F *corrE_hist = new TH1F("energySCEle_corr","energySCEle_corr (_7-_5)/_5",10000,-0.4,0.4);
	TH1F *E5x5_hist = new TH1F("e5x5SCEle","e5x5SCEle (_7-_5)/_5",10000,-0.4,0.4);
	TH1F *R9_hist = new TH1F("R9Ele","R9Ele (_7-_5)",10000,-0.4,0.4);
	TH1F *etaSC_hist = new TH1F("etaSCEle","etaSCEle (_7-_5)",10000,-0.01,0.01);
	TH1F *phiSC_hist = new TH1F("phiSCEle","phiSCEle (_7-_5)",10000,-0.01,0.01);
	TH1F *eta_hist = new TH1F("etaEle","etaEle (_7-_5)",10000,-0.01,0.01);
	TH1F *phi_hist = new TH1F("phiEle","phiEle (_7-_5)",10000,-0.01,0.01);
	TH1F *pModeGsf_hist = new TH1F("pModeGSf","pmode (_7-_5)/_5",10000,-0.02,0.02);
	TH1F *EbyP_hist = new TH1F("EbyP","E/p (_7-_5)",10000,-0.5,0.5);
	TProfile *fbrem = new TProfile("fbrem","fbrem _7/_5",1000,-5,5,0,2);
			...
			; loop++)
	{
		...
		if (entryNumber%10000==0){
			...
			if (eleIndex[0]==1)
			{
				...
				rawE_hist->Fill((energySCEle_raw7[0]-energySCEle_raw5[0])/energySCEle_raw5[0],selection5);
				rawE_hist->Fill((energySCEle_raw7[1]-energySCEle_raw5[1])/energySCEle_raw5[1],selection5);
				corrE_hist->Fill((energySCEle_corr7[0]-energySCEle_corr5[0])/energySCEle_corr5[0],selection5);
				corrE_hist->Fill((energySCEle_corr7[1]-energySCEle_corr5[1])/energySCEle_corr5[1],selection5);
			...
			if (eleIndex[0]==2)
			{
				...
				E5x5_hist->Fill((e5x5SCEle7[1]-e5x5SCEle5[0])/e5x5SCEle5[0],selection5);
				E5x5_hist->Fill((e5x5SCEle7[0]-e5x5SCEle5[1])/e5x5SCEle5[1],selection5);
	...
	corrE_hist->Draw();
	t->SaveAs("selectionPlots/corrEnergySC.pdf");
	rawE_hist->Draw();
	t->SaveAs("selectionPlots/rawEnergySC.pdf");
	E_hist->Draw();
	t->SaveAs("selectionPlots/energySC.pdf");
	E5x5_hist->Draw();
	t->SaveAs("selectionPlots/e5x5SC.pdf");
	etaSC_hist->Draw();
	...
	fbrem->Draw();
	t->SaveAs("selectionPlots/fbrem.pdf");
