...
int fullRunExtraPlotsAB() 
{
	...
	//LOOPS
	for(Int_t overLoop=0;overLoop<2;overLoop++)
	{
...
//		graph_eff_EELoR9->SetPointError(histCounter,histCounter,effSigma_val);
	...
	t1->SaveAs("fullRunExtraPlotsAB/effSigma_vs_nPV.pdf");
	...
	t2->SaveAs("fullRunExtraPlotsAB/gausSigma_vs_nPV.pdf");
	...
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlotsAB/Zee_corr_1.pdf");
	Label1.str("");
	Label1.clear();
	Label2.str("");
	Label2.clear();
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlotsAB/Zee_corr_2.pdf");
	Label1.str("");
	Label1.clear();
	Label2.str("");
	Label2.clear();
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlotsAB/Zee_corr_3.pdf");
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlotsAB/Zee_corr_4.pdf");
	...
	t4->SaveAs("fullRunExtraPlotsAB/clusterSize_dist.pdf");

	TCanvas *t5 = new TCanvas("t5","t5",600,600);
	clusterSize->Draw();
	t5->SaveAs("fullRunExtraPlotsAB/clusterSize_profile.pdf");
	...
	t6->SaveAs("fullRunExtraPlotsAB/ratio_profile.pdf");
...
gausSigma(EE_corr5);
gausSigma(EE_corr7);
t7->SaveAs("fullRunExtraPlotsAB/t7.pdf");
	//end function
	return 0;
}
