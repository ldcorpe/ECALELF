...
int fullRunExtraPlotsABCD() 
{
	...
	TProfile *clusterSize = new TProfile("size","#Delta nHits vs nVtx",40,0,40);
	clusterSize->GetXaxis()->SetTitle("nVtx");
	clusterSize->GetYaxis()->SetTitle("#Delta nHits");
	clusterSize->GetYaxis()->SetTitleOffset(1.3);
	TProfile *clusterSize_5 = new TProfile("size_5","nHits vs nVtx",40,0,40);
	clusterSize_5->GetYaxis()->SetTitle("nHits");
	clusterSize_5->GetXaxis()->SetTitle("nVtx");
	clusterSize_5->GetYaxis()->SetTitleOffset(1.3);
	TProfile *clusterSize_7 = new TProfile("size_7","nHits vs nVtz",40,0,40);
	clusterSize_7->GetXaxis()->SetTitle("nVtx");
	clusterSize_7->GetYaxis()->SetTitle("nHits");
	clusterSize_7->GetYaxis()->SetTitleOffset(1.3);
...
{EE_corr7->Fill(invMass_corr7,selection5);}
	...
	for (histCounter =0; histCounter <1 ; histCounter++)
	{
Float_t buffer;
...
mg_eff_EBHiR9->Draw("APL");
	...
	mg_eff_EELoR9->SetTitle("EE, R9 < 0.94");
	mg_eff_EEHiR9->SetTitle("EE, R9 > 0.94");
	mg_eff_EBLoR9->SetTitle("EB, R9 < 0.94");
	mg_eff_EBHiR9->SetTitle("EB, R9 > 0.94");
	
	mg_eff_EELoR9->GetXaxis()->SetTitle("nVtx");
	mg_eff_EEHiR9->GetXaxis()->SetTitle("nVtx");
	mg_eff_EBLoR9->GetXaxis()->SetTitle("nVtx");
	mg_eff_EBHiR9->GetXaxis()->SetTitle("nVtx");
	
	mg_eff_EELoR9->GetYaxis()->SetTitle("#sigma_{eff7}/#sigma_{eff5}");
	mg_eff_EEHiR9->GetYaxis()->SetTitle("#sigma_{eff7}/#sigma_{eff5}");
	mg_eff_EBLoR9->GetYaxis()->SetTitle("#sigma_{eff7}/#sigma_{eff5}");
	mg_eff_EBHiR9->GetYaxis()->SetTitle("#sigma_{eff7}/#sigma_{eff5}");
	
	mg_eff_EELoR9->GetYaxis()->SetTitleOffset(1.3);
	mg_eff_EEHiR9->GetYaxis()->SetTitleOffset(1.3);
	mg_eff_EBLoR9->GetYaxis()->SetTitleOffset(1.3);
	mg_eff_EBHiR9->GetYaxis()->SetTitleOffset(1.3);
	...
	t1->cd(4);
mg_eff_EBHiR9->Draw("APL");
	t1->SaveAs("fullRunExtraPlotsABCD/effSigma_vs_nPV.pdf");
	...
	t2->SaveAs("fullRunExtraPlotsABCD/gausSigma_vs_nPV.pdf");
	...
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlotsABCD/Zee_corr_1.pdf");
	Label1.str("");
	Label1.clear();
	Label2.str("");
	Label2.clear();
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlotsABCD/Zee_corr_2.pdf");
	Label1.str("");
	Label1.clear();
	Label2.str("");
	Label2.clear();
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlotsABCD/Zee_corr_3.pdf");
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlotsABCD/Zee_corr_4.pdf");
	...
	t4->SaveAs("fullRunExtraPlotsABCD/clusterSize_dist.pdf");

	TCanvas *t5 = new TCanvas("t5","t5",600,600);
	clusterSize->Draw();
	t5->SaveAs("fullRunExtraPlotsABCD/clusterSize_profile.pdf");
	...
	t6->SaveAs("fullRunExtraPlotsABCD/ratio_profile.pdf");
...
gausSigma(EE_corr5);
gausSigma(EE_corr7);
t7->SaveAs("fullRunExtraPlotsABCD/t7.pdf");
	//end function
	return 0;
}
