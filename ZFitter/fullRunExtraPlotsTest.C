...
int fullRunExtraPlotsTest() 
{
	...
	//LOOPS
	for(Int_t overLoop=3;overLoop<4;overLoop++)
	{
		...
		/*		cout << PtEle5[0] << " " << PtEle5[1] << " "<< PtEle7[0]<< " " << PtEle7[1]<< endl;
				...
				cout << nPV5 << " " << nPV7 << " "<< nHitsSCEle5[0]<< " " << nHitsSCEle5[1]<< endl;
				cout <<  energySCEle_corr5[0]<< " " << energySCEle_corr5[1]<< " " << energySCEle_corr7[0] << " " << energySCEle_corr7[1] << endl;*/
			}
...
//		graph_eff_EELoR9->SetPointError(histCounter,histCounter,effSigma_val);
	...
	t1->SaveAs("fullRunExtraPlots/effSigma_vs_nPV.pdf");
	...
	t2->SaveAs("fullRunExtraPlots/gausSigma_vs_nPV.pdf");
	...
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlots/Zee_corr_1.pdf");
	Label1.str("");
	Label1.clear();
	Label2.str("");
	Label2.clear();
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlots/Zee_corr_2.pdf");
	Label1.str("");
	Label1.clear();
	Label2.str("");
	Label2.clear();
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlots/Zee_corr_3.pdf");
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunExtraPlots/Zee_corr_4.pdf");
	...
	t4->SaveAs("fullRunExtraPlots/clusterSize_dist.pdf");

	TCanvas *t5 = new TCanvas("t5","t5",600,600);
	clusterSize->Draw();
	t5->SaveAs("fullRunExtraPlots/clusterSize_profile.pdf");
	...
	t6->SaveAs("fullRunExtraPlots/ratio_profile.pdf");
