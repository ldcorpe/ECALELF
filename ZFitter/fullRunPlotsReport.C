...
TGaxis::SetMaxDigits(2);
	...
	TH1F *corrE_hist_EE = new TH1F("energySCEle_corr_EE","EE E_{corr} fractional difference",1000,-0.2,0.2);
	TH1F *corrE_hist_EE_7 = new TH1F("energySCEle_corr_EE_7","EE E_{corr} distributions",1000,0,400);
	TH1F *corrE_hist_EE_5 = new TH1F("energySCEle_corr_EE_5","EE E_{corr} distributions",1000,0,400);
	TH1F *E_hist_EB = new TH1F("energySCEle_EB","EB E_{corr} fractional difference",1000,-0.2,0.2);
	TH1F *E3x3_hist_EB = new TH1F("energySCEle3x3_EB"," fractional difference",1000,-0.2,0.2);
	TH1F *rawE_hist_EB = new TH1F("energySCEle_raw_EB","energySCEle_raw_EB fractional difference",1000,-0.2,0.2);
	TH1F *corrE_hist_EB = new TH1F("energySCEle_corr_EB","EB E_{corr} fractional difference",1000,-0.2,0.2);
	TH1F *corrE_hist_EB_7 = new TH1F("energySCEle_corr_EB_7","EB E_{corr} distributions",1000,0,400);
	TH1F *corrE_hist_EB_5 = new TH1F("energySCEle_corr_EB_5","EB E_{corr} distributions",1000,0,400);
	TH1F *E5x5_hist = new TH1F("e5x5SCEle","e5x5SCEle fractional difference",10000,-0.2,0.2);
	TH1F *R9_hist_5 = new TH1F("R9Ele5","R9 distributions",1000,0,1.2);
	TH1F *R9_hist_7 = new TH1F("R9Ele7","R9 distributions",1000,0,1.2);
	TH1F *R9_hist = new TH1F("R9Ele","R9 difference",1000,-0.4,0.4);
	TH1F *etaSC_hist = new TH1F("etaSCEle","#eta_{SC} difference",100,-0.001,0.001);
	TH1F *phiSC_hist = new TH1F("phiSCEle","#phi_{SC} difference",100,-0.001,0.001);
	TH1F *eta_hist = new TH1F("etaEle","#eta difference",100,-0.001,0.001);
	TH1F *phi_hist = new TH1F("phiEle","#phi difference",100,-0.001,0.001);
	...
	TProfile *corrE_profile = new TProfile("corrE_profile","E_{corr} ratio vs #eta",500,-2.5,2.5);
	...
	//Z->ee distributions
	TH1F *EEinvMassGold7 = new TH1F("EEinvMassGold7","EE invMass,  R_9 > 0.94",100,40,140);
	...
	TH1F *EEinvMassGold_corr7 = new TH1F("EinvMassGold_corr7","EE M_{corr}(ee), R9 > 0.94",100,40,140);
	TH1F *EEinvMassBad_corr7 = new TH1F( "EinvMassBad_corr7" ,"EE M_{corr}(ee), R9 < 0.94" ,100,40,140);
	TH1F *EBinvMassGold_corr7 = new TH1F("BinvMassGold_corr7","EB M_{corr}(ee), R9 > 0.94",100,40,140);
	TH1F *EBinvMassBad_corr7 = new TH1F( "BinvMassBad_corr7 ","EB M_{corr}(ee), R9 < 0.94",100,40,140);
	TH1F *EEinvMassGold_corr5 = new TH1F("EEinvMassGold_cor5","EE M_{corr}(ee), R9 > 0.94",100,40,140);
	TH1F *EEinvMassBad_corr5 = new TH1F( "EinvMassBad_corr5" ,"EE M_{corr}(ee), R9 < 0.94" ,100,40,140);
	TH1F *EBinvMassGold_corr5 = new TH1F("BinvMassGold_corr5","EB M_{corr}(ee), R9 > 0.94",100,40,140);
	TH1F *EBinvMassBad_corr5 = new TH1F( "BinvMassBad_corr5 ","EB M_{corr}(ee), R9 < 0.94",100,40,140);

	//iEta and iPhi Plots
	TProfile2D *r9 = new TProfile2D("mean_deltar9","mean #Delta R9 vs #eta",360,1,360,170,-85,85,"s");
	TProfile2D *e_sc = new TProfile2D("mean_change_e_sc","mean cha e_sc",360,1,360,170,-85,85,"s");
...
//LOOPS
	for(Int_t overLoop=0;overLoop<4;overLoop++)
	{
...
/*			if (eleIndex[0]==1)
	...
	corrE_hist_EE_7->GetYaxis()->SetTitleOffset(1.3);
	corrE_hist_EE_7->GetYaxis()->SetTitle("Events/0.4");
	corrE_hist_EE_7->GetYaxis()->SetLabelSize(0.02);
	...
	corrE_hist_EE_5->GetYaxis()->SetTitle("Events/0.4");
	corrE_hist_EE_5->GetYaxis()->SetTitleOffset(1.3);
	corrE_hist_EE_5->GetYaxis()->SetLabelSize(0.02);

	t->SaveAs("fullRunPlotsReport/corrEnergySC_EE_dists.pdf");
	pt->Clear();
	pt2->Clear();
	corrE_hist_EE->Draw();
	corrE_hist_EE->GetXaxis()->SetTitle("E_{70X}-E_{53X}/E_{53X}");
	corrE_hist_EE->GetYaxis()->SetTitle("Events/0.0004");
	corrE_hist_EE->GetYaxis()->SetTitleOffset(1.3);
	corrE_hist_EE->GetYaxis()->SetLabelSize(0.02);
	effSigma(corrE_hist_EE);
	pt2->AddText(effSigma_cstr);
	pt2->Draw();

	t->SaveAs("fullRunPlotsReport/corrEnergySC_EE.pdf");
	pt2->Clear();
	...
	corrE_hist_EB_5->GetYaxis()->SetTitle("Events/0.4");
	corrE_hist_EB_5->GetYaxis()->SetTitleOffset(1.3);
	corrE_hist_EB_5->GetYaxis()->SetLabelSize(0.02);
	...
	t->SaveAs("fullRunPlotsReport/corrEnergySC_EB_dists.pdf");
	pt->Clear();
	pt2->Clear();
	/*	rawE_hist_EE->Draw();
			t->SaveAs("fullRunPlotsReport/rawEnergySC_EE.pdf");
			E_hist_EE->Draw();
			t->SaveAs("fullRunPlotsReport/energySC_EE.pdf");
			E3x3_hist_EE->Draw();
			t->SaveAs("fullRunPlotsReport/e3x3SC_EE.pdf");*/
	corrE_hist_EB->Draw();
	corrE_hist_EB->GetXaxis()->SetTitle("E_{70X}-E_{53X}/E_{53X}");
	corrE_hist_EB->GetYaxis()->SetTitle("Events/0.0004");
	corrE_hist_EB->GetYaxis()->SetTitleOffset(1.3);
	corrE_hist_EB->GetYaxis()->SetLabelSize(0.02);
	effSigma(corrE_hist_EB);
	pt2->AddText(effSigma_cstr);
	pt2->Draw();
	t->SaveAs("fullRunPlotsReport/corrEnergySC_EB.pdf");
	pt->Clear();
	pt2->Clear();
	/*	rawE_hist_EB->Draw();
			t->SaveAs("fullRunPlotsReport/rawEnergySC_EB.pdf");
			E_hist_EB->Draw();
			t->SaveAs("fullRunPlotsReport/energySC_EB.pdf");
			E3x3_hist_EB->Draw();
			t->SaveAs("fullRunPlotsReport/e3x3SC_EB.pdf");*/
	...
	corrE_profile->GetYaxis()->SetTitleOffset(1.3);
	
	t->SaveAs("fullRunPlotsReport/corrE_profile.pdf");

	R9_hist_5->Draw();
	R9_hist_7->Draw("same");
	R9_hist_5->GetXaxis()->SetTitle("R_{9}");
	R9_hist_5->GetYaxis()->SetTitle("Events/0.0012");
	R9_hist_5->GetYaxis()->SetTitleOffset(1.3);
	t->SaveAs("fullRunPlotsReport/R9_dist.pdf");
	...
	R9_hist->GetYaxis()->SetTitle("Events/0.0008");
	R9_hist->GetYaxis()->SetTitleOffset(1.3);
	t->SaveAs("fullRunPlotsReport/R9.pdf");
...
/*			R9_profile->SetMinimum(0.8);
	...
	R9_profile->GetYaxis()->SetTitleOffset(1.3);
	t->SaveAs("fullRunPlotsReport/R9_profile.pdf");
	...
	etaSC_hist->GetYaxis()->SetTitle("Events/0.00002");
	etaSC_hist->GetYaxis()->SetTitleOffset(1.4);
	t->SaveAs("fullRunPlotsReport/etaSC.pdf");
	...
	phiSC_hist->GetYaxis()->SetTitle("Events/0.00002");
	phiSC_hist->GetYaxis()->SetTitleOffset(1.4);
	t->SaveAs("fullRunPlotsReport/phiSC.pdf");
	...
	eta_hist->GetYaxis()->SetTitle("Events/0.00002");
	eta_hist->GetYaxis()->SetTitleOffset(1.4);
	t->SaveAs("fullRunPlotsReport/eta.pdf");
	...
	phi_hist->GetYaxis()->SetTitle("Events/0.00002");
	phi_hist->GetYaxis()->SetTitleOffset(1.4);
	t->SaveAs("fullRunPlotsReport/phi.pdf");
	...
	pt2->AddText(effSigma_cstr);
	pt2->Draw();
	t->SaveAs("fullRunPlotsReport/EbyP_dist.pdf");
	...
	t->SaveAs("fullRunPlotsReport/EbyP.pdf");
	...
	t->SaveAs("fullRunPlotsReport/EbyP_profile.pdf");
	...
	pModeGsf_hist->GetYaxis()->SetTitle("Events/0.00004");
	pModeGsf_hist->GetYaxis()->SetTitleOffset(1.3);
	t->SaveAs("fullRunPlotsReport/pModeGsf.pdf");
	//	fbrem->SetMimimum(0.8);
	//	fbrem->SetMaximum(1.2);
	fbrem->Draw();
	fbrem->GetXaxis()->SetTitle("#eta");
	fbrem->GetYaxis()->SetTitle("f_{brem7}/f_{brem5}");
	fbrem->GetYaxis()->SetTitleOffset(1.3);
	t->SaveAs("fullRunPlotsReport/fbrem2.pdf");*/
	...
	/*	//Draw iEta and iPhi plots
			...
			r9_error->Draw("colz");
			t2->SaveAs("fullRunPlotsReport/iEtaPhiR9.pdf");
			t2->cd(1);
			...
			t2->SaveAs("fullRunPlotsReport/iEtaPhiEsc.pdf");
			t2->cd(1);
			...
			t2->SaveAs("fullRunPlotsReport/iEtaPhiE_raw.pdf");
			t2->cd(1);
			...
			t2->SaveAs("fullRunPlotsReport/iEtaPhiR9_alternative.pdf");
			t2->cd(1);
			...
			t2->SaveAs("fullRunPlotsReport/iEtaPhiEsc_alternative.pdf");
			gStyle->SetOptStat(1);*/
	...
	/*	t3->cd(1);
			...
			t3->SaveAs("fullRunPlotsReport/Zee.pdf");
			...
			t3->SaveAs("fullRunPlotsReport/Zee_raw.pdf");*/
	...
	EEinvMassGold_corr7->GetYaxis()->SetTitle("Events/1");
	EEinvMassGold_corr5->GetYaxis()->SetTitle("Events/1");
	EBinvMassGold_corr7->GetYaxis()->SetTitle("Events/1");
	EBinvMassGold_corr5->GetYaxis()->SetTitle("Events/1");
	EEinvMassBad_corr7-> GetYaxis()->SetTitle("Events/1");
	EEinvMassBad_corr5-> GetYaxis()->SetTitle("Events/1");
	EBinvMassBad_corr7-> GetYaxis()->SetTitle("Events/1");
	EBinvMassBad_corr5-> GetYaxis()->SetTitle("Events/1");
	EEinvMassGold_corr7->GetYaxis()->SetTitleOffset(1.3);
	EEinvMassGold_corr5->GetYaxis()->SetTitleOffset(1.3);
	EBinvMassGold_corr7->GetYaxis()->SetTitleOffset(1.3);
	EBinvMassGold_corr5->GetYaxis()->SetTitleOffset(1.3);
	EEinvMassBad_corr7-> GetYaxis()->SetTitleOffset(1.3);
	EEinvMassBad_corr5-> GetYaxis()->SetTitleOffset(1.3);
	EBinvMassBad_corr7-> GetYaxis()->SetTitleOffset(1.3);
	EBinvMassBad_corr5-> GetYaxis()->SetTitleOffset(1.3);
	EEinvMassGold_corr7->GetYaxis()->SetLabelSize(0.02);
	EEinvMassGold_corr5->GetYaxis()->SetLabelSize(0.02);
	EBinvMassGold_corr7->GetYaxis()->SetLabelSize(0.02);
	EBinvMassGold_corr5->GetYaxis()->SetLabelSize(0.02);
	EEinvMassBad_corr7-> GetYaxis()->SetLabelSize(0.02);
	EEinvMassBad_corr5-> GetYaxis()->SetLabelSize(0.02);
	EBinvMassBad_corr7-> GetYaxis()->SetLabelSize(0.02);
	EBinvMassBad_corr5-> GetYaxis()->SetLabelSize(0.02);
	...
	pt0b->Draw();
	t3->SaveAs("fullRunPlotsReport/Zee_corr_1.pdf");
	Label1.str("");
	Label1.clear();
	Label2.str("");
	Label2.clear();
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunPlotsReport/Zee_corr_2.pdf");
	Label1.str("");
	Label1.clear();
	Label2.str("");
	Label2.clear();
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunPlotsReport/Zee_corr_3.pdf");
	...
	pt0b->AddText(Label4.str().c_str());
	pt0b->Draw();
	t3->SaveAs("fullRunPlotsReport/Zee_corr_4.pdf");
